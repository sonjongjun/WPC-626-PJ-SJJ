...
piz8.addEventListener("click", () => {
  ...
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info8").style.transition =
...
piz1.addEventListener("click", () => {
  ...
  document.querySelector(".sl-piz-info8").style.translate = "100% 0%";
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info1").style.transition =
    "translate 0.5s ease-in-out";
}); //click이벤트
...
piz2.addEventListener("click", () => {
  ...
  document.querySelector(".sl-piz-info8").style.translate = "100% 0%";
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info2").style.transition =
    "translate 0.5s ease-in-out";
}); //click이벤트
piz3.addEventListener("click", () => {
  ...
  document.querySelector(".sl-piz-info8").style.translate = "100% 0%";
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info3").style.transition =
    "translate 0.5s ease-in-out";
}); //click이벤트
piz4.addEventListener("click", () => {
  ...
  document.querySelector(".sl-piz-info8").style.translate = "100% 0%";
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info4").style.transition =
    "translate 0.5s ease-in-out";
}); //click이벤트
piz5.addEventListener("click", () => {
  ...
  document.querySelector(".sl-piz-info8").style.translate = "100% 0%";
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info5").style.transition =
    "translate 0.5s ease-in-out";
}); //click이벤트
piz6.addEventListener("click", () => {
  ...
  document.querySelector(".sl-piz-info8").style.translate = "100% 0%";
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info6").style.transition =
    "translate 0.5s ease-in-out";
}); //click이벤트
piz7.addEventListener("click", () => {
  ...
  document.querySelector(".sl-piz-info8").style.translate = "100% 0%";
  // 트랜지션 효과 부여
  document.querySelector(".sl-piz-info7").style.transition =
    "translate 0.5s ease-in-out";
}); //click이벤트
...
// 스와이퍼 안에있는 피자 이미지 클릭시 location.href = "04.pizza_delivery-1.html?no=" + seq; 처럼 상세페이지로 이동하기
const $pizInfo2 = $(".m-piz-area img");
console.log("개수:", $pizInfo2.length);
$pizInfo2.on("click", function (e) {
  e.preventDefault();
  // 순번체크
  let seq2 = $(this).attr("alt").substr(2);
  console.log("순번:", seq2);
  location.href = "04.pizza_delivery-1.html?no=" + seq2;
});
